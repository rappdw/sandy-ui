...
**0.8.0** → #30 (D7 compat gate), #31 (D8a walkthrough), #32 (auto-restore), #36 (--update-sessions cooperation: sticky reconnect / restart-safe discovery / staleness surface — gated on sandy 1.2.0, feature-detected) ·
